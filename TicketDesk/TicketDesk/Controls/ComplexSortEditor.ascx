            ...
            <div class="reorderList" style="width: 100%; ">
                        ...
                        <ajaxToolkit:ReorderList DragHandleAlignment="Left" CallbackCssStyle="reorderListCallbackStyle"
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton ImageAlign="Top"  ID="ChangeSortDirection" ToolTip="Change Sort Direction" runat="server"
                                    ImageUrl="~/Controls/Images/swap.gif"  CommandName="direction" />
                                <asp:ImageButton ImageAlign="Top"  ID="RemoveSort" ToolTip="Remove from Sort" runat="server" ImageUrl="~/Controls/Images/delete.gif"
                                    CommandName="delete" Visible='<%#  EnableSortDelete()%>' CommandArgument='<%# Container.DataItemIndex %>' />
                            </ItemTemplate>
                            <InsertItemTemplate>
...
<asp:Panel ID="Panel1" Style="float: right; margin-left: 5px;" runat="server">
    Sort:
    <asp:Label ID="DisplaySort" runat="server" />
    <asp:ImageButton ImageUrl="~/Controls/Images/editor_small.gif" 
        CausesValidation="false" ID="ShowChangeSortButton"
        ToolTip="Advanced Sorting" runat="server" Text="..." />
