...
namespace TicketDesk.Engine.Linq
{
    ...
    partial void OnFileContentsChanged();
		...
		[Association(Name="Ticket_TicketAttachment", Storage="_Ticket", ThisKey="TicketId", IsForeignKey=true)]
    ...
    partial void OnTicketIdChanged();
		...
		[Association(Name="Ticket_TicketTag", Storage="_Ticket", ThisKey="TicketId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Ticket Ticket
		{
			get
			{
    ...
    partial void OnVersionChanged();
		...
		[Association(Name="Ticket_TicketComment", Storage="_Ticket", ThisKey="TicketId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Ticket Ticket
		{
			get
			{
    ...
    partial void OnVersionChanged();
		...
		[Association(Name="Ticket_TicketAttachment", Storage="_TicketAttachments", OtherKey="TicketId")]
		...
		[Association(Name="Ticket_TicketTag", Storage="_TicketTags", OtherKey="TicketId")]
		...
		[Association(Name="Ticket_TicketComment", Storage="_TicketComments", OtherKey="TicketId")]
