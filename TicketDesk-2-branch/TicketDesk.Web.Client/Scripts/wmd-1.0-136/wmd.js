...
Attacklab.wmdBase = function(){
	...
	wmd.PanelCollection = function(){
	    this.buttonBar = $(".wmd-button-bar").first(); //doc.getElementById("wmd-button-bar");
	    this.preview = $(".wmd-preview").first(); //doc.getElementById("wmd-preview");
	    this.output = $(".wmd-output").first(); //doc.getElementById("wmd-output");
	    this.input = $(".wmd-input").first(); //doc.getElementById("wmd-input");
	};
