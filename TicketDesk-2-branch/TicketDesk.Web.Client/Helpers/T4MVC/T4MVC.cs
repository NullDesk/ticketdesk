...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static class uploadify {
            ...
            public static readonly string jquery_uploadify_init_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.uploadify.init.min.js") ? Url("jquery.uploadify.init.min.js") : Url("jquery.uploadify.init.js");
                          
            public static readonly string jquery_uploadify_v2_1_0_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery.uploadify.v2.1.0.min.js") ? Url("jquery.uploadify.v2.1.0.min.js") : Url("jquery.uploadify.v2.1.0.js");
                          
            public static readonly string jquery_uploadify_v2_1_0_min_js = Url("jquery.uploadify.v2.1.0.min.js");
            ...
            public static readonly string Uploadify_v2_1_0_Manual_pdf = Url("Uploadify v2.1.0 Manual.pdf");
            public static readonly string uploadify_allglyphs_swf = Url("uploadify.allglyphs.swf");
            public static readonly string uploadify_css = Url("uploadify.css");
            ...
            public static readonly string uploadifySelect_png = Url("uploadifySelect.png");
        }
        ...
        public static class wmd_1_0_136 {
            ...
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class images {
                private const string URLPATH = "~/Scripts/wmd-1.0-136/images";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string wmd_buttons_png = Url("wmd-buttons.png");
                public static readonly string wmd_buttons_psd = Url("wmd-buttons.psd");
            ...
            public static class Img {
                private const string URLPATH = "~/Scripts/wmd-1.0-136/Img";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string wmd_buttons_png = Url("wmd-buttons.png");
                public static readonly string wmd_buttons2_png = Url("wmd-buttons2.png");
            ...
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class markdown_1_0_1 {
                private const string URLPATH = "~/Scripts/wmd-1.0-136/markdown 1.0.1";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string License_text = Url("License.text");
                public static readonly string Markdown_Readme_text = Url("Markdown Readme.text");
                public static readonly string Markdown_pl = Url("Markdown.pl");
            }
        
            public static readonly string mit_license_txt = Url("mit license.txt");
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class original_wmd_1_0_1 {
                private const string URLPATH = "~/Scripts/wmd-1.0-136/original-wmd-1.0.1";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string apiExample_html = Url("apiExample.html");
                public static readonly string minimalExample_html = Url("minimalExample.html");
                public static readonly string optionsExample_html = Url("optionsExample.html");
                public static readonly string readme_txt = Url("readme.txt");
                [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
                public static class wmd {
                    private const string URLPATH = "~/Scripts/wmd-1.0-136/original-wmd-1.0.1/wmd";
                    public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                    public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
                    public static class images {
                        private const string URLPATH = "~/Scripts/wmd-1.0-136/original-wmd-1.0.1/wmd/images";
                        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                        public static readonly string bg_fill_png = Url("bg-fill.png");
                        ...
                        public static readonly string italic_png = Url("italic.png");
                        public static readonly string link_png = Url("link.png");
                        public static readonly string ol_png = Url("ol.png");
                        public static readonly string redo_png = Url("redo.png");
                        public static readonly string separator_png = Url("separator.png");
                        public static readonly string ul_png = Url("ul.png");
                        public static readonly string undo_png = Url("undo.png");
                        public static readonly string wmd_on_png = Url("wmd-on.png");
                        public static readonly string wmd_png = Url("wmd.png");
                    }
                
                    public static readonly string showdown_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/showdown.min.js") ? Url("showdown.min.js") : Url("showdown.js");
                                  
                    public static readonly string wmd_base_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/wmd-base.min.js") ? Url("wmd-base.min.js") : Url("wmd-base.js");
                                  
                    public static readonly string wmd_plus_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/wmd-plus.min.js") ? Url("wmd-plus.min.js") : Url("wmd-plus.js");
            ...
            public static readonly string tdwmd_css = Url("tdwmd.css");
            public static readonly string Uservoice_bugs_txt = Url("Uservoice bugs.txt");
            public static readonly string wmd_test_html = Url("wmd-test.html");
            public static readonly string wmd_css = Url("wmd.css");
            public static readonly string wmd_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/wmd.min.js") ? Url("wmd.min.js") : Url("wmd.js");
